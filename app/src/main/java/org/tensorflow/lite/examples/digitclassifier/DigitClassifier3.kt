...
//
//
//class DigitClassifier3(val context: Context) {
...
//  }
//
//  fun VectorToCosineSim():MutableList<Float>{
//    var list = mutableListOf<Float>()
//
//    for (i in getPredictImage()){
//      list.add(CosineSim(Coba(classify(loadImageFile(context.assets, "predict/original-image.jpg")).outputBuffer),Coba(classify(loadImageFile(context.assets, "predict/$i")).outputBuffer)))
//    }
//
